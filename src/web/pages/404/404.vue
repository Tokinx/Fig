...
import { getFigClientConfig } from "@/lib/fig-client-config";

const figClientConfig = getFigClientConfig();

const DATA = ref({
  PAGE: figClientConfig.template,
  LINK: figClientConfig.target_url,
  NOTES: figClientConfig.notes,
});
