    ...
    <DialogContent class="max-w-2xl max-h-[90vh] overflow-y-auto">
      ...
      <div class="space-y-6">
            ...
            <div class="space-y-2">
              ...
              <div class="flex mt-2 gap-2">
                <div class="flex w-full relative">
                  ...
                  <Input
                    type="text"
                    :class="['rounded-l-none ml-[-1px]', !state.isCreate && 'bg-slate-100']"
                    v-model="state.formData.slug"
                    placeholder="短链接"
        ...
        <div class="flex items-center justify-end gap-3 pt-4">
          <Button variant="outline" @click="close(false)" :disabled="loading.create"> 取消 </Button>
