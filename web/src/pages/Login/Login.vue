...
<template>
  <div class="container px-4 relative flex-col items-center grid lg:max-w-none lg:px-0 h-screen bg-slate-100">
    ...
    <div class="space-y-4 w-full sm:max-w-[800px] mx-auto">
      <Card class="flex flex-col sm:flex-row w-full min-h-[360px] bg-white border-0 shadow-none rounded-2xl p-4">
        <div class="mx-auto">
          <div class="h-full flex items-center justify-center px-[8%] pt-8 sm:pt-0">
            ...
            <!-- <img src="@/assets/undraw_just-browsing_0rpb.svg" alt="Logo" class="max-w-[300px] h-full" /> -->
            <svg
              class="max-w-[300px] h-full"
            ...
            >
              ...
              <path
                ...
                fill="#e6e6e6"
              />
              <ellipse cx="30.5814" cy="15.64507" rx="8.45661" ry="8.64507" fill="#3f3d56" />
              <ellipse cx="59.79515" cy="15.64507" rx="8.45661" ry="8.64507" fill="#3f3d56" />
              <ellipse cx="89.00891" cy="15.64507" rx="8.45661" ry="8.64507" fill="#3f3d56" />
              <path
              ...
              <path
                ...
                fill="#dadada"
              />
              <circle cx="375.61448" cy="50" r="22" fill="#a0616a" />
              <path
        ...
        <div class="relative m-4 hidden sm:block">
      ...
      <div class="flex items-center flex-col sm:flex-row justify-center text-xs text-muted-foreground">
